//! Complete x86_64 Linux syscall number table.
//!
//! Every syscall from 0 (read) through 335+ (map_shadow_stack) is defined here.
//! Each constant maps the syscall name to its number as used in RAX.

// ============================================================================
// Syscall numbers — x86_64 Linux ABI
// Complete table from arch/x86/entry/syscalls/syscall_64.tbl
// ============================================================================
...
pub const SYSCALL_MAX: u64 = 456;

/// Returns the name of a syscall given its number, for logging.
